...
class AuthService:
    ...
    def register(
        ...
        *,
        ...
        with self.uow as session:
            ...
            try:
                self.user_storage.get_user_by_email(
                    session=session,
                    email=email,
                )
            ...
            created_user = self.user_storage.create_user(
    ...
    def login(
        ...
        *,
        ...
        with self.uow as session:
            ...
            try:
                user = self.user_storage.get_user_by_email(
                    session=session,
                    email=email,)
    ...
    def get_user_by_id(
        ...
        *,
        ...
        with self.uow as session:
            ...
            return self.user_storage.get_user_by_id(
                session=session,
                user_id=user_id,
            )
    ...
    def get_user_from_token(self, token: str) -> User:
        ...
        with self.uow as session:
           try:
                user = self.user_storage.get_user_by_id(
                session=session,
                user_id=user_id
            )
           except NotFoundError:    
